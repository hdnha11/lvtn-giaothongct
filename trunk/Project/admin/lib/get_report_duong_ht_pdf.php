...
TABLE;
			...
			while ($duong = pg_fetch_object($dsDuong)) {
				...
				$reportContent .= '<td width="11%" align="right">' . $duong->chieu_dai . ' km</td>';
				$reportContent .= '<td width="11%" align="right">' . $duong->rong_nen . ' m</td>';
				$reportContent .= '<td width="11%" align="right">' . $duong->rong_mat . ' m</td>';
				$reportContent .= '<td width="10%" align="left">' . $duong->quy_mo . '</td>';
				$reportContent .= '<td width="11%" align="right">' . $duong->tai_trong . ' tấn</td>';
